...
#define STRING_CONFIG_H_AUTHOR "(Your Mom)" // Who made the changes.
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  // This is Edwin & Thor fiddling - Aug 18, 2017
  #define  DEFAULT_Kp 13.47
  #define  DEFAULT_Ki 0.85
  #define  DEFAULT_Kd 53.63
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 470 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 7.5, 25 }
